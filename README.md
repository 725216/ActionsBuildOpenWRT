...
集成进固件的插件列表：luci-app-docker,luci-app-aria2,luci-app-transmission,luci-app-openvpn,luci-app-samba4,luci-app-taskplan,luci-app-openclash,luci-app-upnp,luci-app-autoreboot,store,mpd,upmpdcli,mympd
